...
# Try common local tokenizer locations first.
candidate_tokenizer_paths = [
    ROOT / "tokenizer" / "NedoTurkishTokenizer",
    ROOT / "NedoTurkishTokenizer",
    ROOT / "scripts",
    Path("/arf/scratch/egitimg16/tokenizer/NedoTurkishTokenizer"),
    Path("/arf/scratch/egitimg16/NedoTurkishTokenizer"),
]

for _p in candidate_tokenizer_paths:
    if (_p / "nedo_turkish_tokenizer.py").exists():
...
def import_train_module():
    path = str(Path(__file__).resolve().parent / "20_train_qwen_style.py")
